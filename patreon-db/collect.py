...
FOMC_DATES_BY_YEAR = {
    2016: [
        __import__('datetime').date(2016, 1, 27),
        __import__('datetime').date(2016, 3, 16),
        __import__('datetime').date(2016, 4, 27),
        __import__('datetime').date(2016, 6, 15),
        __import__('datetime').date(2016, 7, 27),
        __import__('datetime').date(2016, 9, 21),
        __import__('datetime').date(2016, 11, 2),
        __import__('datetime').date(2016, 12, 14),
    ],
    2017: [
        __import__('datetime').date(2017, 2, 1),
        __import__('datetime').date(2017, 3, 15),
        __import__('datetime').date(2017, 5, 3),
        __import__('datetime').date(2017, 6, 14),
        __import__('datetime').date(2017, 7, 26),
        __import__('datetime').date(2017, 9, 20),
        __import__('datetime').date(2017, 11, 1),
        __import__('datetime').date(2017, 12, 13),
    ],
    2018: [
        __import__('datetime').date(2018, 1, 31),
        __import__('datetime').date(2018, 3, 21),
        __import__('datetime').date(2018, 5, 2),
        __import__('datetime').date(2018, 6, 13),
        __import__('datetime').date(2018, 8, 1),
        __import__('datetime').date(2018, 9, 26),
        __import__('datetime').date(2018, 11, 8),
        __import__('datetime').date(2018, 12, 19),
    ],
    2019: [
        __import__('datetime').date(2019, 1, 30),
        __import__('datetime').date(2019, 3, 20),
        __import__('datetime').date(2019, 5, 1),
        __import__('datetime').date(2019, 6, 19),
        __import__('datetime').date(2019, 7, 31),
        __import__('datetime').date(2019, 9, 18),
        __import__('datetime').date(2019, 10, 30),
        __import__('datetime').date(2019, 12, 11),
    ],
    2020: [
        __import__('datetime').date(2020, 1, 29),
        __import__('datetime').date(2020, 3, 3),
        __import__('datetime').date(2020, 3, 15),
        __import__('datetime').date(2020, 4, 29),
        __import__('datetime').date(2020, 6, 10),
        __import__('datetime').date(2020, 7, 29),
        __import__('datetime').date(2020, 9, 16),
        __import__('datetime').date(2020, 11, 5),
        __import__('datetime').date(2020, 12, 16),
    ],
    2021: [
        __import__('datetime').date(2021, 1, 27),
        __import__('datetime').date(2021, 3, 17),
        __import__('datetime').date(2021, 4, 28),
        __import__('datetime').date(2021, 6, 16),
        __import__('datetime').date(2021, 7, 28),
        __import__('datetime').date(2021, 9, 22),
        __import__('datetime').date(2021, 11, 3),
        __import__('datetime').date(2021, 12, 15),
    ],
    2022: [
